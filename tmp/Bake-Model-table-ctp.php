	...
	Table
{
     ...
     *
     * @param
	array $config The configuration for the Table.
     * @return
	void
     */
    public function
...
$this->primaryKey([
<?= $this->Bake->stringifyList((array)$primaryKey, ['indent' => false]) ?>
]);
<?php else: ?>
$this->primaryKey('
<?= current((array)$primaryKey) ?>
');
<?php endif ?>
<?php endif ?>
...
<?= $behavior ?>
'
<?= $behaviorData ? ", [" . implode(', ', $behaviorData) . ']' : '' ?>
);
<?php endforeach ?>
...
<?= $alias ?>
', [
<?= $this->Bake->stringifyList($assoc, ['indent' => 3]) ?>
]);
<?php endforeach ?>
<?php endforeach ?>
}
...
/** * Default validation rules. * * @param \Cake\Validation\Validator
$validator Validator instance. * @return \Cake\Validation\Validator */
...
application integrity. * * @param \Cake\ORM\RulesChecker $rules The
rules object to be modified. * @return \Cake\ORM\RulesChecker */ public
...
@return string */ public static function defaultConnectionName() {
return '
<?= $connection ?>
'; }
<?php endif; ?>
