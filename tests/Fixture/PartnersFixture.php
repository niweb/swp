...
class PartnersFixture extends TestFixture
{
    ...
    public $fields = [
        'partner_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        ...
        'telefon' => ['type' => 'string', 'length' => 15, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['partner_id'], 'length' => []],
            'user_id' => ['type' => 'unique', 'columns' => ['user_id', 'student_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
