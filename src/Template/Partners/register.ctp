<div class="partners form large-10 medium-9 columns">
    ...
    <fieldset>
        ...
        <?php
            ...
            echo $this->Form->select('sex', ['label' => 'Dein Geschlecht', 'w' => 'weiblich', 'm' => 'männlich']]);
        ...
        <h3>Patenschaft</h3>
            ...
            echo $this->Form->textarea('support_wish', ['label' => 'Welche Unterstützung wünscht du dir von uns während deiner Patenschaft?']);
            echo $this->Form->textarea('reason_for_decision', ['label' => 'Warum hast du dich für uns entschieden?']);
            echo $this->Form->textarea('additional_informations', ['label' => 'Gibt es sonst noch etwas, was wir über dich wissen sollten?']);
